              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <button
                    ...
                    className={`py-2 rounded-xl text-xs font-semibold border flex items-center justify-center gap-1.5 transition ${
                      newAccRole === 'USER'
                        ? 'bg-slate-500/15 border-slate-500 text-slate-800 dark:text-slate-200 font-bold'
                        : 'bg-slate-50 dark:bg-slate-950 border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400'
                    }`}
                  >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <label className="flex items-center gap-1.5 cursor-pointer">
                      <input
                        ...
                        className="rounded text-rose-600 focus:ring-rose-500 border-slate-300 dark:border-slate-700"
                      />
                  ...
                  {!isNewAccUnlimitedCredits && (
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 focus:border-rose-500 rounded-xl px-3 py-1.5 text-xs text-slate-900 dark:text-slate-200 outline-none"
                      />
