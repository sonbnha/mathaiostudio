  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 antialiased selection:bg-indigo-500 selection:text-white flex flex-col justify-between relative overflow-x-hidden">
      ...
      <main className="relative z-10 w-full flex flex-col">
          ...
          <div className="w-full max-w-5xl rounded-2xl bg-gradient-to-b from-slate-900 to-slate-950 border border-slate-800 p-2 sm:p-3 shadow-2xl shadow-indigo-950/40 relative">
            <div className="rounded-xl bg-slate-950 border border-slate-800/80 overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 min-h-[380px]">
                {/* Left side: Canvas SVG Graphic Preview (7 cols) */}
                ...
                {/* Right side: Lesson Plan Document Preview (5 cols) */}
        ...
        {/* ========================================================================= */}
        {/* PHÂN TẦNG 2: DEEP-DIVE SECTION - HÌNH HỌC SVG DYNAMIC ENGINE */}
        {/* ========================================================================= */}
        <section className="w-full py-20 border-t border-slate-800/60 bg-gradient-to-b from-slate-950 via-slate-900/30 to-slate-950">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              {/* Left Column: Core Features & Benefits */}
              <div className="lg:col-span-6 space-y-6 text-left">
                ...
                <p className="text-sm sm:text-base text-slate-400 leading-relaxed">
                  Quên đi những phần mềm vẽ hình cổ điển phức tạp. Chỉ cần mô tả bài toán bằng ngôn ngữ tự nhiên, hệ thống tự động giải tích toạ độ chính xác, vẽ đường phụ, góc vuông và đặt nhãn điểm thông minh.
                </p>
                ...
                <div className="space-y-4 pt-2">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-slate-200">Xuất file chuyên nghiệp đa định dạng</h4>
                      <p className="text-xs text-slate-400 mt-0.5">Xuất Vector SVG độ nét vô hạn, PNG trong suốt cho Word/PowerPoint và code TikZ cho tài liệu LaTeX.</p>
                    </div>
                  </div>
                </div>
        ...
        {/* ========================================================================= */}
        {/* PHÂN TẦNG 3: DEEP-DIVE SECTION - SOẠN GIÁO ÁN CHUẨN BGD&ĐT 5512 */}
        {/* ========================================================================= */}
        <section className="w-full py-20 border-t border-slate-800/60 bg-gradient-to-b from-slate-950 via-slate-900/20 to-slate-950">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              {/* Left Column: Lesson Plan Document Mockup (Reverse Order) */}
              <div className="lg:col-span-6 order-2 lg:order-1 rounded-2xl bg-slate-900/60 border border-slate-800 p-4 shadow-xl">
                <div className="rounded-xl bg-slate-950 border border-slate-800/80 p-4 space-y-3">
                  ...
                  <div className="p-4 rounded-lg bg-slate-900/70 border border-slate-850 space-y-3 text-left">
              ...
              {/* Right Column: Narrative & CTA (Reverse Order) */}
        ...
        {/* ========================================================================= */}
        {/* PHÂN TẦNG 4: TECH SPECS, ECOSYSTEM STATS & CALL TO ACTION */}
        {/* ========================================================================= */}
