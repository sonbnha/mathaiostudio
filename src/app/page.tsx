...
function HomeLoadingSkeleton() {
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 flex flex-col">
      ...
      <div className="w-full border-b border-slate-800/60 h-16 bg-slate-950/80 backdrop-blur px-4 sm:px-8 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-1.5 hidden sm:block">
            ...
            <div className="w-36 h-3 bg-slate-900/80 rounded animate-pulse" />
          </div>
        </div>
        <div className="flex items-center gap-2.5">
          <div className="w-24 h-8 rounded-full bg-slate-900 border border-slate-800 animate-pulse" />
