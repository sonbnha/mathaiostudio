      ...
      <div className="flex-1 min-h-0 w-full flex">
        ...
        <PanelGroup orientation="horizontal">
          ...
          <PanelResizeHandle className="w-1.5 bg-[#1a1a1b] border-l border-[#2d2d2d] hover:bg-[#3d3d3d] transition-colors cursor-col-resize z-40 flex items-center justify-center relative">
            <div className="absolute top-1/2 -translate-y-1/2 left-0 -translate-x-1/2 w-3 h-8 bg-[#2d2d2d] rounded-l flex flex-col items-center justify-center cursor-pointer border border-[#3d3d3d] border-r-0 hover:bg-[#4d4d4d] z-50 shadow-sm">
          ...
          <Panel defaultSize={85} minSize={20} className="flex flex-col">
            <PanelGroup orientation="horizontal">
              ...
              <PanelResizeHandle className="w-1.5 bg-[#142333] border-l border-[#1a1a1b] hover:bg-[#3d3d3d] transition-colors cursor-col-resize z-20 flex items-center justify-center relative group">
                <div className="absolute top-1/2 -translate-y-1/2 flex flex-col items-center justify-center gap-1 z-50">
                  {/* Sync to PDF */}
