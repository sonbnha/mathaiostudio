        ...
        <PanelGroup orientation="horizontal">
          ...
          <Panel defaultSize={15} minSize={10} className="bg-[#1a1a1b] flex flex-col z-20">
            <PanelGroup orientation="vertical">
              ...
              <PanelResizeHandle className="h-[7px] bg-[#222c38] cursor-row-resize flex items-center justify-center shrink-0 z-30">
          ...
          <PanelResizeHandle className="w-[7px] bg-[#222c38] cursor-col-resize z-30 relative shrink-0">
